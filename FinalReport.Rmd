...
As mentioned above, we have data on flu visits, flu tests, levels of flu vaccination, and flu mortality from the C.D.C. These were separate datasets that we downloaded from the C.D.C website. We will discuss some of the challenges with working with this data in order. First off, let us look at flu visits data:
